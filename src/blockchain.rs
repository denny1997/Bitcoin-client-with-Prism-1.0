...
impl Blockchain {
    ...
    pub fn new() -> Self {
        ...
        // let t1 = [255; 16];
        // let t2 = [0; 8];
        let mut difficultyForPr: [u8; 32] = [0,0,127,0,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255];
        let mut difficultyForTx: [u8; 32] = [0,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255];
